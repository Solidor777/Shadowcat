...
test("renders a linked token using the actor's visual", () => {
  ...
  const actor = buildActorDoc(
    "w1",
    "G",
    { displayName: "G", visual: { kind: "image", asset: "actorimg" }, size: { w: 1, h: 1 }, shape: "square", faction: null, conditions: [], prototype: false, vision: null, light: null, movement: [] },
    "act1",
  );
...
test("resolves the faction border color from the registry", () => {
  ...
  const actor = buildActorDoc(
    "w1",
    "G",
    { displayName: "G", visual: { kind: "image", asset: "actorimg" }, size: { w: 1, h: 1 }, shape: "square", faction: "f1", conditions: [], prototype: false, vision: null, light: null, movement: [] },
    "act1",
  );
...
test("resolves condition icon glyphs into token badges via the registry", () => {
  ...
  const actor = buildActorDoc(
    "w1",
    "G",
    { displayName: "G", visual: { kind: "image", asset: "actorimg" }, size: { w: 1, h: 1 }, shape: "square", faction: null, conditions: ["dead", "prone"], prototype: false, vision: null, light: null, movement: [] },
    "act1",
  );
  const token = buildTokenFromActor("w1", "scene1", actor, "link", { x: 0, y: 0 }, { w: 100, h: 100 }, "tok1");
  store.applyCommand(cmd(1, [{ op: "create", doc: registry }, { op: "create", doc: actor }, { op: "create", doc: token }]));
...
test("reconciles a token to the server's resolved extent, with the shape still read from the actor", () => {
  ...
  const actor = buildActorDoc(
    "w1",
    "Ogre",
    { displayName: "Ogre", visual: { kind: "image", asset: "a1" }, size: { w: 2, h: 2 }, shape: "circle", faction: null, conditions: [], prototype: false, vision: null, light: null, movement: [] },
    "act1",
  );
  const token = buildTokenFromActor("w1", "scene1", actor, "link", { x: 0, y: 0 }, { w: 100, h: 100 }, "tok1");
...
test("renders an animated frame-list visual with resolved frame URLs", () => {
  ...
  const actor = buildActorDoc(
    "w1",
    "Wisp",
    { displayName: "Wisp", visual: { kind: "animated", source: { type: "frames", frames: ["f1", "f2"] }, fps: 6, loop: true }, size: { w: 1, h: 1 }, shape: "square", faction: null, conditions: [], prototype: false, vision: null, light: null, movement: [] },
    "act1",
  );
  const token = buildTokenFromActor("w1", "scene1", actor, "link", { x: 0, y: 0 }, { w: 100, h: 100 }, "tok1");
  store.applyCommand(cmd(1, [{ op: "create", doc: actor }, { op: "create", doc: token }]));
...
test("renders an animated grid-sheet visual with a resolved sheet URL", () => {
  ...
  const actor = buildActorDoc(
    "w1",
    "Torch",
    { displayName: "Torch", visual: { kind: "animated", source: { type: "sheet", asset: "sheet1", rows: 2, cols: 4, count: 7 }, fps: 12, loop: false }, size: { w: 1, h: 1 }, shape: "square", faction: null, conditions: [], prototype: false, vision: null, light: null, movement: [] },
    "act1",
  );
  const token = buildTokenFromActor("w1", "scene1", actor, "link", { x: 0, y: 0 }, { w: 100, h: 100 }, "tok1");
  store.applyCommand(cmd(1, [{ op: "create", doc: actor }, { op: "create", doc: token }]));
...
test("renders an animated grid-sheet visual with a null count coalesced to undefined", () => {
  ...
  const actor = buildActorDoc(
    "w1",
    "Torch",
    { displayName: "Torch", visual: { kind: "animated", source: { type: "sheet", asset: "sheet1", rows: 2, cols: 4, count: null }, fps: 12, loop: false }, size: { w: 1, h: 1 }, shape: "square", faction: null, conditions: [], prototype: false, vision: null, light: null, movement: [] },
    "act1",
  );
  const token = buildTokenFromActor("w1", "scene1", actor, "link", { x: 0, y: 0 }, { w: 100, h: 100 }, "tok1");
  store.applyCommand(cmd(1, [{ op: "create", doc: actor }, { op: "create", doc: token }]));
...
test("a token whose visual fails to resolve (empty faces) is skipped, not crashed", () => {
  ...
  const actor = buildActorDoc(
    "w1",
    "Broken",
    { displayName: "Broken", visual: { kind: "faces", faces: {}, default: "x", faceMap: null }, size: { w: 1, h: 1 }, shape: "square", faction: null, conditions: [], prototype: false, vision: null, light: null, movement: [] },
    "act1",
  );
  const token = buildTokenFromActor("w1", "scene1", actor, "link", { x: 0, y: 0 }, { w: 100, h: 100 }, "tok1");
  store.applyCommand(cmd(1, [{ op: "create", doc: actor }, { op: "create", doc: token }]));
