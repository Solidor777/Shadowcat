...
test("MockBackend records token upserts and removals", () => {
  ...
  b.setToken("t1", { x: 0, y: 0, w: 100, h: 100, rotation: 0, visual: { kind: "image", url: "/a" }, borderColor: null, badges: [], shape: "square", perceived: false });
  expect(b.tokens.get("t1")).toEqual({ x: 0, y: 0, w: 100, h: 100, rotation: 0, visual: { kind: "image", url: "/a" }, borderColor: null, badges: [], shape: "square", perceived: false });
  b.setToken("t1", { x: 10, y: 0, w: 100, h: 100, rotation: 0, visual: { kind: "image", url: "/a" }, borderColor: null, badges: [], shape: "square", perceived: false });
  expect(b.tokens.get("t1")!.x).toBe(10);
  b.removeToken("t1");
  expect(b.tokens.has("t1")).toBe(false);
});

test("MockBackend records the perceived flag verbatim", () => {
  const b = new MockBackend();
  b.setToken("t1", { x: 0, y: 0, w: 100, h: 100, rotation: 0, visual: { kind: "image", url: "/a" }, borderColor: null, badges: [], shape: "square", perceived: true });
  expect(b.tokens.get("t1")!.perceived).toBe(true);
  b.setToken("t1", { x: 0, y: 0, w: 100, h: 100, rotation: 0, visual: { kind: "image", url: "/a" }, borderColor: null, badges: [], shape: "square", perceived: false });
  expect(b.tokens.get("t1")!.perceived).toBe(false);
});
...
test("MockBackend records an animated token visual and accepts tickTokenAnimations calls", () => {
  ...
  b.setToken("t1", { x: 0, y: 0, w: 100, h: 100, rotation: 0, visual, borderColor: null, badges: [], shape: "square", perceived: false });
