<script lang="ts">
  ...
  setAppContext({ contributions: registry, store: new DocumentStore(), documents: new DocumentStore(), world: "test", role: "gm", members: new Map(), t, assets: new AssetResolver(), onAssetChanged: () => () => {}, subscribeScene: () => ({ unsubscribe() {} }), dispatchIntent: () => {}, scene: new SceneInteractionBridge(), sendPing: () => {}, onPing: () => () => {}, leaveWorld: () => {} });
</script>
