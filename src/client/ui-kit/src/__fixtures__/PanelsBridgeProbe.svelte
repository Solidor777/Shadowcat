<script lang="ts">
  import type { PanelsBridge } from "../panelsBridge.svelte";

  /** Reads `bridge.minimized` through a `$derived` — mirrors a real consumer
...
<div data-testid="minimized">{minimized.join(",")}</div>
