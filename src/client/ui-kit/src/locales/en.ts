...
export const en: Messages = {
  ...
  "settings.members.title": "World members",
  "settings.members.username": "Account name",
  "settings.members.role": "World role",
  "settings.members.add": "Add to world",
  "settings.members.added": "Added {username} to this world.",
  "settings.members.error": "Could not add member: {message}",
