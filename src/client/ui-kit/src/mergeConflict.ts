 ...
 * user resolves mine-vs-theirs. Declared in a plain TS module rather than inside
 * `MergeConflictModal` itself, so tsc-based consumers (TypeDoc, d.ts emit) can resolve the
 * named export — a Svelte component module exposes only a default export to plain tsc. */
