<script lang="ts">
  ...
  import { buildActorDoc, setNameHidden, actorDisplayName, listAssets, resolveTokenActor, type ActorEngine, type WireDocument, type FactionRegistryEngine, type Faction, type TokenVisual, type FaceVisual, type AnimatedSource, type ConditionRegistryEngine, type Condition, type WireSearchHit, type SubscriptionHandle } from "@shadowcat/core";
