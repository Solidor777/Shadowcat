...
describe("server-seeded faction registry", () => {
  it("mounting the panel never dispatches a registry create, even for a GM on an empty store (the server seeds it at world creation/join)", async () => {
    const dispatchIntent = vi.fn();
