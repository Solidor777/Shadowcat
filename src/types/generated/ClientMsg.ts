 ...
 */
path: Array<[number, number]>, } | { "type": "send_message", channel: string, content: string, actor_owner: ActorOwnerRef | null, audience: Audience, } | { "type": "edit_message", message_id: string, content: string, };
